  ...
  return (
    <div className="space-y-6 animate-fade-in">
       <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-slate-800 border border-slate-700 rounded-lg p-4 h-80 flex flex-col">
             <h3 className="text-slate-300 font-medium mb-2 text-center">Структура поступлений</h3>
          ...
          <div className="md:col-span-2 bg-slate-800 border border-slate-700 rounded-lg p-4 h-80">
             <h3 className="text-slate-300 font-medium mb-4">Исполнение бюджета расходов (ТОП-5)</h3>
             <ResponsiveContainer width="100%" height="100%">
       ...
       <div className="bg-slate-800 border border-slate-700 rounded-lg p-6">
          <h3 className="text-slate-300 font-medium mb-6">Дебиторская задолженность</h3>
